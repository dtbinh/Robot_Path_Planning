...
SensorModel.Move.R{1}=diag([1^2,(0.2*pi/180)^2]);
SensorModel.Move.R{2}=diag([1^2,(0.2*pi/180)^2]);
...
% save('Sim1Data','TargetPos','Trajectories','SensorModel','Time')
close all
nk=10;
figure(3)
...
%     title(strcat(num2str(kk),'_',num2str(ck)))
        pause(0.1)
