...
Nn=6; %the number of nodes on each axis
...
%    plot_prop_paper
save('UAV_movTarg','orig_PDFk','new_PDFk','Hnm','Hc','I','X','Xtraj','newpath','newcol','model','sens','x_mc','xc','yc','Nn')