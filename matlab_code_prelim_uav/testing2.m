...
model.fn=2;
model.hn=2;
model.hx=@(x,para)[atan2(x(2)-xc1(2),x(1)-xc1(1));atan2(x(2)-xc2(2),x(1)-xc2(1))];
model.gx=@(x,para)[sensor2penalty(x,xc1,para(1:2)),0;0,sensor2penalty(x,xc2,para(3:4))];
...
contour(x,y,CC,25)
plot_sens_view(xc1,para(2),para(1),80)
plot_sens_view(xc2,para(4),para(3),80)
axis([0,50,0,50])
